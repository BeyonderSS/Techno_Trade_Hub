...
import { BoltIcon, BarChart2, TrendingUp } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <header className=" border-gray-800 p-3 sm:p-4 sticky top-0 z-10 bg-black/95 backdrop-blur-sm">
        <div className="container mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4 w-full sm:w-auto">
            <div className="flex flex-wrap gap-2 w-full sm:w-auto">
              <Badge
                variant="outline"
                className="bg-gray-800 text-emerald-400 border-emerald-400 text-xs sm:text-sm"
              >
                Balance: 25,432.56 USDT
              </Badge>
              <Badge
                variant="outline"
                className="bg-gray-800 text-yellow-400 border-yellow-400 text-xs sm:text-sm"
              >
              ...
              <CardContent className="p-3 sm:p-6 space-y-3 text-xs sm:text-sm">
                ...
                <div className="pt-2 border-t border-gray-800">
                  <p className="text-gray-300">
                    AI is currently focusing on momentum trading with BTC and
                    ETH pairs. Market conditions show strong bullish signals
